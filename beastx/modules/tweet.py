...
@beast.on(admin_cmd(outgoing=True, pattern="trump ?(.*)"))
...
@beast.on(admin_cmd(outgoing=True, pattern="johnny ?(.*)"))
...
@beast.on(admin_cmd(outgoing=True, pattern="bhau ?(.*)"))
...
@beast.on(admin_cmd(outgoing=True, pattern="sunny ?(.*)"))
...
@beast.on(admin_cmd(outgoing=True, pattern="joker ?(.*)"))
async def j(event):
    text = event.pattern_match.group(1)
    text = re.sub("&", "", text)
    reply_to_id = event.message
...
@beast.on(admin_cmd(outgoing=True, pattern="modi ?(.*)"))
...
@beast.on(admin_cmd(outgoing=True, pattern="mia ?(.*)"))
async def mia(event):
    text = event.pattern_match.group(1)
    text = re.sub("&", "", text)
    reply_to_id = event.message
...
@beast.on(admin_cmd(outgoing=True, pattern="cmm ?(.*)"))
async def cmm(event):
    text = event.pattern_match.group(1)
    text = re.sub("&", "", text)
    reply_to_id = event.message
...
@beast.on(admin_cmd(outgoing=True, pattern="type ?(.*)"))
...
@beast.on(admin_cmd(outgoing=True, pattern="waifu ?(.*)"))
...
@beast.on(admin_cmd(outgoing=True, pattern="tweet ?(.*)"))
...
@beast.on(admin_cmd(pattern="tweetme(?: |$)(.*)"))
