...
from . import *
import os , shutil
sedpath = "./beastx/downloads/"
if not os.path.isdir(sedpath):
    os.makedirs(sedpath)
@beast.on(admin_cmd(pattern=r"cblur"))
async def hom(event):
    ...
    await event.client.send_file(event.chat_id, "beast.jpg", force_document=False, reply_to=event.reply_to_msg_id)
