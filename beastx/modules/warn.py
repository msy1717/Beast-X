...
@beast(outgoing=True, pattern="^!warn(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
    try:
...
@beast(outgoing=True, pattern="^!warns(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = await event.get_reply_message()
...
@beast(outgoing=True, pattern="^!setwarnmode(?: |$)(.*)")
...
@beast(outgoing=True, pattern="^!setwarnlimit(?: |$)(.*)")
...
@beast(outgoing=True, pattern="^!resetwarns(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
    reply_message = await event.get_reply_message()
