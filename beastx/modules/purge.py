...
from beastx.utils import errors_handler

from . import *
# @register(outgoing=True, pattern="^.purge$")
@beast.on(beastx_cmd(pattern=r"purge"))
@errors_handler
...
@beast.on(beastx_cmd(pattern=r"purgeme"))
@errors_handler
...
@beast.on(beastx_cmd(pattern=r"edit"))
@errors_handler
...
@beast.on(beastx_cmd(pattern=r"sd"))
@errors_handler
