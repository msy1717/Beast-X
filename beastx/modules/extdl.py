...
from beastx.utils import command, remove_plugin, load_module

from pathlib import Path
from beastx import LOAD_PLUG
import sys
import asyncio
import traceback
import os
...
async def install(event):
    ...
    for ixo in total_doxx:
        ...
        downloaded_file_name = await event.client.download_media(await borg.get_messages(chat, ids=mxo), "beastx/modules/")
