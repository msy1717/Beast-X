...
from ..utils import edit_or_reply, beastx_cmd, sudo_cmd
...
@beast.on(beastx_cmd(outgoing=True, pattern="magisk$"))
@beast.on(sudo_cmd(pattern="magisk$", allow_sudo=True))
...
@beast.on(beastx_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
@beast.on(sudo_cmd(pattern="device(?: |$)(\S*)", allow_sudo=True))
...
@beast.on(
    beastx_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)")
)
@beast.on(sudo_cmd(pattern="codename(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@beast.on(beastx_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
@beast.on(sudo_cmd(pattern="specs(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@beast.on(beastx_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
@beast.on(sudo_cmd(pattern="twrp(?: |$)(\S*)", allow_sudo=True))
